	...
	<div class="newsletter">
		...
		<ul class="benefits">
			...
			<li class="benefit">
				...
				<p>Nothing inspires like a beautiful transformation. Nobody does it better than KILZ.</p>
			</li>
			<li class="benefit">
		...
		<div class="signup">
			<div class="message" id="message">
				<h2>CONNECT TO KILZ</h2>
				<p>Oops! You're already registered. Keep up an eye on your inbox for the latest news, tips and photos!</p>
			</div>
		</div>
	</div>
